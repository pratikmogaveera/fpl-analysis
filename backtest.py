...
DEF_WEIGHTS = {
    # ep_next bumped 0.15→0.25, ict_index trimmed 0.20→0.15, clean_sheets_per_90 trimmed 0.15→0.10
    # validated: Spearman r 0.441 avg, GW2 top-10 precision 30% (vs 20% original)
    "ep_next": 0.25,
    "fdr": 0.15,
...
MID_WEIGHTS = {
    # ep_next bumped 0.07→0.20, ict_index trimmed 0.32→0.22, defensive_contribution trimmed 0.13→0.10
    # validated: Spearman r 0.546 avg, GW2 top-10 precision 30% (vs 20% original)
    "ep_next": 0.20,
    "fdr": 0.18,
    "chance_of_playing_next_round": 0.10,
    "ict_index": 0.22,
